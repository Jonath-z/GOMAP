...
import { locationExist } from '../../modules/location.checking';

export const ContributeFrom = (props) => {
    ...
    const addLocation = () => {
        ...
        if (lat !== undefined && lat !== null && long !== undefined && long !== null) {
            const locationExistState = locationExist(quarter.trim(), avenue.trim(), number.trim(), lat, long);
            if (!locationExistState) {
                ...
                setLat()
                setLong();
                console.log(locationExistState);
            }
            if(locationExistState) {
                alert('this location exists yet');
                console.log(locationExistState);
            }
        }
    }
